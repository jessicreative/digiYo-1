...
pub contract Example_Token {

    // Total supply of all tokens in existence.
    pub var totalSupply: UFix64
    // do we need to break this up to account for tiers of cards?
    ...
    //
    pub resource interface Primary_Marketplace_Provider {
    ...
    // new tokens.
    // 
    pub resource Vault: Primary_Marketplace_Provider, Receiver, Balance {
    ...
    pub resource VaultMinter {
        ...
        pub fun mintTokens(amount: UFix64, recipient: Capability<&AnyResource{Receiver}>) {
            ...
            Example_Token.totalSupply = Example_Token.totalSupply + UFix64(amount)
